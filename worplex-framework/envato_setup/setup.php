...
if (!class_exists('Envato_Theme_Setup_Wizard')) {
    ...
    class Envato_Theme_Setup_Wizard {
        ...
        /** @var string Full url to server-script.php (available from https://gist.github.com/miraclesoftsolutions ) */
        ...
        /**
         * worplex_tgmpa instance storage
         *
         * @var object
         */
        protected $worplex_tgmpa_instance;

        /**
         * worplex_tgmpa Menu slug
         *
         * @var string
         */
        protected $worplex_tgmpa_menu_slug = 'worplex-install-plugins';

        /**
         * worplex_tgmpa Menu url
         *
         * @var string
         */
        protected $worplex_tgmpa_url = 'themes.php?page=worplex-install-plugins';
        ...
        public function init_globals() {
            ...
            $this->envato_username = apply_filters($this->theme_name . '_theme_setup_wizard_username', 'miraclesoftsolutions');
            $this->oauth_script = apply_filters($this->theme_name . '_theme_setup_wizard_oauth_script', 'https://demo.miraclesoftsolutions.com/api/server-script.php');
            ...
            $this->plugin_url = worplex_framework_get_url('envato_setup');
        }
        ...
        public function init_actions() {
            if (apply_filters($this->theme_name . '_enable_setup_wizard', true) && current_user_can('manage_options')) {
                ...
                if (class_exists('TGM_Plugin_Activation') && isset($GLOBALS['worplex_tgmpa'])) {
                    add_action('init', array($this, 'get_worplex_tgmpa_instanse'), 30);
                    add_action('init', array($this, 'set_worplex_tgmpa_url'), 40);
                }
                ...
                add_filter('worplex_tgmpa_load', array($this, 'worplex_tgmpa_load'), 10, 1);
        ...
        public function worplex_tgmpa_load($status) {
        ...
        /**
         * Get configured worplex_tgmpa instance
         *
         * @access public
         * @since 1.1.2
         */
        public function get_worplex_tgmpa_instanse() {
            $this->worplex_tgmpa_instance = call_user_func(array(get_class($GLOBALS['worplex_tgmpa']), 'get_instance'));
        }

        /**
         * Update $worplex_tgmpa_menu_slug and $worplex_tgmpa_parent_slug from worplex_tgmpa instance
         *
         * @access public
         * @since 1.1.2
         */
        public function set_worplex_tgmpa_url() {

            $this->worplex_tgmpa_menu_slug = ( property_exists($this->worplex_tgmpa_instance, 'menu') ) ? $this->worplex_tgmpa_instance->menu : $this->worplex_tgmpa_menu_slug;
            $this->worplex_tgmpa_menu_slug = apply_filters($this->theme_name . '_theme_setup_wizard_worplex_tgmpa_menu_slug', $this->worplex_tgmpa_menu_slug);

            $worplex_tgmpa_parent_slug = ( property_exists($this->worplex_tgmpa_instance, 'parent_slug') && $this->worplex_tgmpa_instance->parent_slug !== 'themes.php' ) ? 'admin.php' : 'themes.php';

            $this->worplex_tgmpa_url = apply_filters($this->theme_name . '_theme_setup_wizard_worplex_tgmpa_url', $worplex_tgmpa_parent_slug . '?page=' . $this->worplex_tgmpa_menu_slug);
        }
        ...
        public function init_wizard_steps() {
            ...
            if (class_exists('Worplex_TGM_Plugin_Activation') && isset($GLOBALS['worplex_tgmpa'])) {
        ...
        public function setup_wizard() {
            ...
            wp_localize_script('envato-setup', 'envato_setup_params', array(
                'tgm_plugin_nonce' => array(
                    'update' => wp_create_nonce('worplex_tgmpa-update'),
                    'install' => wp_create_nonce('worplex_tgmpa-install'),
                ),
                'tgm_bulk_url' => admin_url($this->worplex_tgmpa_url),
        ...
        public function setup_wizard_header() { ?>
            ...
            <html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
                ...
                <body class="envato-setup wp-core-ui" style="border:none;">
                    <h1 id="wc-logo">
                        <a href="http://themeforest.net/user/miraclesoftsolutions/portfolio" target="_blank"><?php
        ...
        private function _get_plugins() {
            $instance = call_user_func(array(get_class($GLOBALS['worplex_tgmpa']), 'get_instance'));
            $plugins = array(
        ...
        public function envato_setup_default_plugins() {
            ...
            worplex_tgmpa_load_bulk_installer();
        ...
        public function ajax_plugins() {
            ...
            foreach ($plugins['activate'] as $slug => $plugin) {
                if ($_POST['slug'] == $slug) {
                    $json = array(
                        'url' => admin_url($this->worplex_tgmpa_url),
                        'plugin' => array($slug),
                        'worplex_tgmpa-page' => $this->worplex_tgmpa_menu_slug,
                        'plugin_status' => 'all',
                        '_wpnonce' => wp_create_nonce('bulk-plugins'),
                        'action' => 'worplex_tgmpa-bulk-activate',
                        'action2' => - 1,
            ...
            foreach ($plugins['update'] as $slug => $plugin) {
                if ($_POST['slug'] == $slug) {
                    $json = array(
                        ...
                        'plugin_status' => 'all',
                        '_wpnonce' => wp_create_nonce('bulk-plugins'),
                        'action' => 'worplex_tgmpa-bulk-update',
                        'action2' => - 1,
            ...
            foreach ($plugins['install'] as $slug => $plugin) {
                if ($_POST['slug'] == $slug) {
                    $json = array(
                        ...
                        'plugin_status' => 'all',
                        '_wpnonce' => wp_create_nonce('bulk-plugins'),
                        'action' => 'worplex_tgmpa-bulk-install',
                        'action2' => - 1,
        ...
        private function _content_rev_slider_install() {
            ...
            if (function_exists('worplex_demo_data_get_path')) {
                $theme_style = worplex_demo_data_get_path('content/' . basename(get_theme_mod('dtbwp_site_style', $this->get_default_theme_style())) . '/');
        ...
        private function _content_users_install() {
            ...
            $domain = 'miraclesoftsolutions.com';
            ...
            if (!empty($jobs_list)) {
                ...
                foreach ($jobs_list as $job_item) {
                    ...
                    update_post_meta($job_id, 'worplex_field_job_posted_by', $employer_id);
                    update_post_meta($job_id, 'worplex_job_employer_status', 'approved');
                    $job_count++;
                }
            }
            //
            ...
            if (!empty($candidates_list)) {
                ...
                foreach ($candidates_list as $candidate_item) {
                    ...
                    $user_arr['role'] = 'worplex_candidate';
            ...
            if (!empty($employers_list)) {
                ...
                foreach ($employers_list as $employer_item) {
                    ...
                    $user_arr['nickname'] = $first_name;
                    $user_arr['display_name'] = $post_title;
                    $user_arr['role'] = 'worplex_employer';
                ...
                foreach ($users_array as $user) {
                    ...
                    if (!email_exists($email)) {
                        ...
                        if (isset($user['role']) && $user['role'] != '') {
                            if ($user['role'] == 'worplex_employer') {
                                wp_update_user(array('ID' => $id, 'role' => 'worplex_employer'));

                                if (isset($user['member_id']) && $user['member_id'] != '') {
                                    update_user_meta($id, 'worplex_employer_id', $user['member_id']);
                                    update_post_meta($user['member_id'], 'worplex_user_id', $id);
                                }
                            } else {
                                wp_update_user(array('ID' => $id, 'role' => 'worplex_candidate'));

                                if (isset($user['member_id']) && $user['member_id'] != '') {
                                    update_user_meta($id, 'worplex_candidate_id', $user['member_id']);
                                    update_post_meta($user['member_id'], 'worplex_user_id', $id);
                                }
                            }
                        }
        ...
        private function _fetch_remote_file($url, $post) {
            ...
            if (function_exists('worplex_demo_data_get_path')) {
                $local_file = worplex_demo_data_get_path('content/images/') . $file_name;
            } else {
                $local_file = worplex_framework_get_path('demo-data-setup/content/images/stock/') . $file_name;
            }
            $upload = false;
        ...
        public function _content_wpbakery_templates() {
            ...
            if (function_exists('worplex_demo_data_get_path')) {
                ...
                $wp_bakery_dir = worplex_demo_data_get_path('content/') . 'wp_bakery_templates/';
        ...
        public function _theme_options_install() {
            ...
            if (isset($custom_options['worplex_framework_options'])) {
                $optionsss = json_decode($custom_options['worplex_framework_options'], true);
                //$redux = ReduxFrameworkInstances::get_instance('worplex_framework_options');
                //$redux->set_options($optionsss);
                update_option('worplex_framework_options', $optionsss);
            }
            ...
            if (isset($optionsss['worplex-site-logo']['url'])) {
                $get_thoptions = get_option('worplex_framework_options');
                $get_thoptions['worplex-site-logo']['url'] = $optionsss['worplex-site-logo']['url'];
                update_option('worplex_framework_options', $get_thoptions);
            }
        ...
        public function _custom_fields_install() {
            ...
            if (isset($custom_options['worplex_custom_field_job'])) {
                $optionsss = maybe_unserialize($custom_options['worplex_custom_field_job']);
                update_option('worplex_custom_field_job', $optionsss);
            }
            if (isset($custom_options['worplex_custom_field_candidate'])) {
                $optionsss = maybe_unserialize($custom_options['worplex_custom_field_candidate']);
                update_option('worplex_custom_field_candidate', $optionsss);
            }
            if (isset($custom_options['worplex_custom_field_employer'])) {
                $optionsss = maybe_unserialize($custom_options['worplex_custom_field_employer']);
                update_option('worplex_custom_field_employer', $optionsss);
            }
        ...
        public function _get_json($file, $path = '') {
            ...
            if (is_file($theme_style . basename($file))) {
                ...
                if (file_exists($file_name)) {
                    ...
                    if (strpos($file_content, 'https:\\\/\\\/worplex.net\\\/' . basename(get_theme_mod('dtbwp_site_style', $this->get_default_theme_style())) . '\\\/') !== false) {
                        $find_url = 'https:\\\/\\\/worplex.net\\\/' . basename(get_theme_mod('dtbwp_site_style', $this->get_default_theme_style())) . '\\\/';
                        $file_content = str_replace(array($find_url), array($replace_url_with), $file_content);
                    } else if (strpos($file_content, 'https:\\\/\\\/worplex.net\\\/demo\\\/') !== false) {
                        $find_url = 'https:\\\/\\\/worplex.net\\\/demo\\\/';
                ...
                <input type="hidden" name="new_style" id="new_style" value="">
                    ...
                    <p><em>Please Note: Advanced changes to website graphics/colors may require extensive PhotoShop and Web
                            Development knowledge. We recommend hiring an expert from <a
                                href="https://support.miraclesoftsolutions.com/"
                                target="_blank">Miraclesoftsolutions</a> to assist with any advanced website changes.</em></p>
                    <div style="display: none;">
                        <img src="https://support.miraclesoftsolutions.com/"
                             width="1" height="1"/>
                    </div>
        ...
        public function envato_setup_logo_design() {
            ...
            <form method="post">
                <p><?php printf(esc_html__('Please add your logo below. For best results, the logo should be a transparent PNG ( 466 by 277 pixels). The logo can be changed at any time from the Appearance > Customize area in your dashboard. Try %sMiraclesoftsolutions%s if you need a new logo designed.'), '<a href="https://support.miraclesoftsolutions.com" target="_blank">', '</a>'); ?></p>
        ...
        public function envato_setup_logo_design_save() {
            ...
            global $WorplexFrameReduxFramework;
            $theme_options = get_option('worplex_framework_options');
            ...
            // copied from miraclesoftsolutions.theme_options.php
            if ($new_logo_id) {
                ...
                if ($attr && !empty($attr[1]) && !empty($attr[2])) {
                    ...
                    if ($attr && isset($attr[0]) && !empty($attr[0])) {
                        ...
                        //$WorplexFrameReduxFramework->ReduxFramework->set('worplex-site-logo', $logo_image);
                        $theme_options['worplex-site-logo']['url'] = $attr[0];
                        update_option('worplex_framework_options', $theme_options);
                    }
                }
            } else {
                $image_url = $this->plugin_url . '/images/' . get_theme_mod('dtbwp_site_style', $this->get_default_theme_style()) . '/logo.png';
                ...
                //$WorplexFrameReduxFramework->ReduxFramework->set('worplex-site-logo', $logo_image);
                $theme_options['worplex-site-logo']['url'] = $image_url;
                update_option('worplex_framework_options', $theme_options);
            }
                        ...
                        <p>
                            <em>On the next page you will be asked to Login with your ThemeForest account and grant
                                permissions to enable Automatic Updates. If you have any questions please <a
                                    href="https://support.miraclesoftsolutions.com/" target="_blank">contact us</a>.</em>
                        </p>
                        <p class="envato-setup-actions step">
                            <input type="submit" class="button-primary button button-large button-next"
        ...
        public function envato_setup_help_support() {
            ...
            <p>Item Support can be accessed from <a href="https://support.miraclesoftsolutions.com/" target="_blank">https://support.miraclesoftsolutions.com/</a>
                and includes:</p>
            <ul>
            ...
            <ul>
                <li>Customization services (this is available through <a
                        href="https://support.miraclesoftsolutions.com"
                        target="_blank">Miraclesoftsolutions</a>)
                </li>
        ...
        public function envato_setup_ready() {
            ...
            <a href="https://twitter.com/share" class="twitter-share-button"
               data-url="http://themeforest.net/user/miraclesoftsolutions/portfolio?ref=miraclesoftsolutions"
            ...
            <p>Please come back and <a href="http://themeforest.net/downloads" target="_blank">leave a 5-star rating</a>
                if you are happy with this theme. <br/>Follow <a href="https://twitter.com/miraclesoftsolutions" target="_blank">@miraclesoftsolutions</a>
            ...
            <div class="envato-setup-next-steps">
                <div class="envato-setup-next-steps-first">
                    ...
                    <ul>
                        <li class="setup-product"><a class="button button-primary button-large"
                                                     href="https://twitter.com/miraclesoftsolutions"
                                                     target="_blank"><?php esc_html_e('Follow @miraclesoftsolutions on Twitter'); ?></a>
                        </li>
                ...
                <div class="envato-setup-next-steps-last">
                    ...
                    <ul>
                        <li class="documentation"><a href="https://support.miraclesoftsolutions.com/documentation/"
                        ...
                        <li class="support"><a href="https://support.miraclesoftsolutions.com/"
