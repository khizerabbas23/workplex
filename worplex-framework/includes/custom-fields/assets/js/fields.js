(function($) {
    ...
    $(function() {
        ...
        function init_tooltip() {
            $(document).on('mouseover', '.cstmfield_tooltip', function() {
        ...
        $('ul.fields').sortable({
            ...
            update: function(event, ui) {
                ...
                $container.find('[name^="cstmfield[fields]"]').each(function() {
        ...
        $(document).on('click', '.cstmfield_add_field', function() {
            var html = WORPLEX_CFS.field_clone.replace(/\[clone\]/g, '['+WORPLEX_CFS.field_index+']');
            $('.fields').append('<li>' + html + '</li>');
            $('.fields li:last .field_label a').click();
            $('.fields li:last .field_type select').change();
            WORPLEX_CFS.field_index = WORPLEX_CFS.field_index + 1;
            init_tooltip();
        });

        // Delete a field
        $(document).on('click', '.cstmfield_delete_field', function() {
            $(this).closest('li').remove();
        });

        // Pop open the edit fields
        $(document).on('click', '.cstmfield_edit_field', function() {
        ...
        $(document).on('change', '.field_form .field_type select', function() {
            ...
            var html = WORPLEX_CFS.options_html[type].replace(/cstmfield\[fields\]\[clone\]/g, input_name);
