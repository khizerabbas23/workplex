...
<section class="middle">
	<div class="container">
        ...
        <a href="javascript:void(0);" class="btn btn-md gray ft-medium rounded" onclick="goBack()"><i class="ti-back-left me-1"></i>Back</a>
    </div>
			...
			<!-- Sidebar -->
				...
				<div class="mt-4">
					...
					<div class="row">
						<div class="col-6">
							<div class="empl-box rounded bg-white d-flex justify-content-center px-4 py-3 border mb-3">
