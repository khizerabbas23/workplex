...
add_filter('worplex_dashboard_candidate_packages_html', 'worplex_dashboard_candidate_packages_html');

function worplex_dashboard_candidate_packages_html() {
    global $current_user;
                            ...
                            <tbody>
                                ...
                                if ($posts_query->have_posts()) {
                                    while ($posts_query->have_posts()) : $posts_query->the_post();
                                        ...
                                        $pkg_expired = worplex_candidate_applics_pkg_expired($order_id);
